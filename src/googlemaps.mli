...
type animation = Bounce [@js 1] | Drop [@js 2] | Nr [@js 3] | Lr [@js 4]
[@@js.enum]
...
type stroke_position = Center [@js 0] | Inside [@js 1] | Outside [@js 2]
[@@js.enum]
...
module Attribution : sig
  ...
  val create :
    ?ios_deep_link_id:string -> ?source:string -> ?web_url:string -> unit -> t
    [@@js.builder]
...
module StreetViewLink : sig
  ...
  val create : ?description:string -> ?heading:int -> ?pano:string -> unit -> t
    [@@js.builder]
...
type street_view_preference = Nearest [@js "nearest"] | Best [@js "best"]
[@@js.enum]
...
type street_view_source = Default [@js "default"] | Outdoor [@js "outdoor"]
[@@js.enum]
...
module StreetViewTileData : sig
  ...
  val get_tile_url :
    t -> pano:string -> tile_zoom:int -> tile_x:int -> tile_y:int -> string
    [@@js.call]
...
module StreetViewPanoRequest : sig
  ...
  val create : pano:string -> t [@@js.builder]
...
module StreetViewService : sig
  ...
  val new_street_view_service : unit -> t [@@js.new]

  val get_panorama :
    StreetViewLocationRequest.t ->
    (StreetViewPanoramaData.t -> street_view_status -> unit) ->
    unit
...
module StreetViewPov : sig
  ...
  val create : heading:int -> pitch:int -> t [@@js.builder]
...
module StreetViewPanoramaOptions : sig
  ...
  val address_control_options : t -> StreetViewAddressControlOptions.t
    [@@js.get]
  ...
  val set_address_control_options :
    t -> StreetViewAddressControlOptions.t -> unit
    [@@js.set]
  ...
  val set_fullscreen_control_options : t -> FullscreenControlOptions.t -> unit
    [@@js.set]
  ...
  val set_pano_provider : t -> (string -> StreetViewPanoramaData.t) -> unit
    [@@js.set]
...
module StreetViewPanorama : sig
  ...
  val register_pano_provider : (string -> StreetViewPanoramaData.t) -> unit
    [@@js.call]

  val set_links : t -> StreetViewLink.t list -> unit [@@js.call]

  val set_options : t -> StreetViewPanoramaOptions.t -> unit [@@js.call]
...
module Data : sig
  ...
  module FeatureOptions : sig
    ...
    val create : ?geometry:Geometry.t -> unit -> t [@@js.builder]
  end

  module Feature : sig
    type t

    val new_feature : ?options:FeatureOptions.t -> unit -> t [@@js.new]
...
module MapTypeStyle : sig
  ...
  val set_element_type : t -> MapTypeStyleElementType.t -> unit [@@js.set]

  val set_feature_type : t -> MapTypeStyleFeatureType.t -> unit [@@js.set]
...
module MapType : sig
  ...
  val get_tile :
    t -> tile_coord:Point.t -> zoom:int -> Converter.Element.t -> unit
    [@@js.call]
...
module MapOptions : sig
  ...
  val set_map_type_control_options : t -> MapTypeControlOptions.t -> unit
    [@@js.set]
...
module Map : sig
  ...
  val new_map : Converter.Element.t -> ?opts:MapOptions.t -> unit -> t
    [@@js.new]
...
module MapCanvasProjection : sig
  ...
  val from_container_pixel_to_lat_lng :
    t -> Point.t -> ?nowrap:bool -> unit -> LatLng.t
    [@@js.call]
  ...
  val from_lat_lng_to_container_pixel : t -> LatLng.t -> Point.t [@@js.call]

  val from_lat_lng_to_div_pixel : t -> LatLng.t -> Point.t [@@js.call]
...
module MarkerPlace : sig
  ...
  val create :
    ?location:LatLng.t -> ?place_id:string -> ?query:string -> unit -> t
    [@@js.builder]
...
module MarkerShape : sig
  ...
  val create : ?coords:float list -> ?type':(string[@js "type"]) -> unit -> t
    [@@js.builder]
...
module Marker : sig
  ...
  val set_map_streetview : t -> StreetViewPanorama.t -> unit
    [@@js.call "setMap"]
...
module InfoWindow : sig
  ...
  val new_info_window : ?opts:InfoWindowOptions.t -> unit -> t [@@js.new]
  ...
  val open' : t -> ?map:Map.t -> ?anchor:MVCObject.t -> unit -> unit
    [@@js.call "open"]

  val open_streetview :
    t -> ?map:StreetViewPanorama.t -> ?anchor:MVCObject.t -> unit -> unit
    [@@js.call "open"]
...
module PolyMouseEvent : sig
  ...
  val create : ?edge:int -> ?path:int -> ?vertex:int -> unit -> t [@@js.builder]
...
module Polygon : sig
  ...
  val new_polygon : ?opts:PolygonOptions.t -> unit -> t [@@js.new]
...
module Rectangle : sig
  ...
  val new_rectangle : ?opts:RectangleOptions.t -> unit -> t [@@js.new]
...
module Event : sig
  ...
  val add_listener :
    Ojs.t -> string -> (MouseEvent.t -> unit) -> MapsEventListener.t
  ...
  val clear_instance_listeners : Ojs.t -> unit
    [@@js.global "google.maps.event.clearInstanceListeners"]

  val clear_listeners : Ojs.t -> string -> unit
    [@@js.global "google.maps.event.clearListeners"]

  val remove_listener : MapsEventListener.t -> unit
...
module GeocoderAddressComponent : sig
  ...
  val create :
    ?long_name:string -> ?short_name:string -> ?types:string list -> unit -> t
    [@@js.verbatim_names] [@@js.builder]
...
module GeocoderGeometry : sig
  ...
  val set_location_type : t -> geocoder_location_type -> unit
    [@@js.verbatim_names]
...
module GeocoderResult : sig
  ...
  val address_components : t -> GeocoderAddressComponent.t list
    [@@js.verbatim_names]
  ...
  val set_address_components : t -> GeocoderAddressComponent.t -> unit
    [@@js.verbatim_names]
...
module Time : sig
  ...
  val create :
    ?text:string -> ?time_zone:string -> ?value:Converter.Date.t -> unit -> t
    [@@js.verbatim_names] [@@js.builder]
...
module Duration : sig
  ...
  val create : ?text:string -> ?value:float -> unit -> t [@@js.builder]
...
module TransitAgency : sig
  ...
  val create : ?name:string -> ?phone:string -> ?url:string -> unit -> t
    [@@js.builder]
...
module TransitStop : sig
  ...
  val create : ?location:LatLng.t -> ?name:string -> unit -> t [@@js.builder]
...
module DirectionsGeocodedWaypoint : sig
  ...
  val create :
    ?partial_match:bool -> ?place_id:string -> ?types:string list -> unit -> t
    [@@js.verbatim_names] [@@js.builder]
...
module DirectionsResult : sig
  ...
  val geocoded_waypoints : t -> DirectionsGeocodedWaypoint.t list [@@js.get]

  val routes : t -> DirectionsRoute.t list [@@js.get]

  val set_geocoded_waypoints : t -> DirectionsGeocodedWaypoint.t list -> unit
    [@@js.set]
...
module DirectionsRendererOptions : sig
  ...
  val set_polyline_options : t -> PolylineOptions.t -> unit
    [@@js.verbatim_names]
...
module DirectionsRenderer : sig
  ...
  val new_direction_renderer : opts:DirectionsRendererOptions.t -> unit -> t
    [@@js.new]
...
type unit_system = Metric [@js 0] | Imperial [@js 1] [@@js.enum]
...
module DirectionsWaypoint : sig
  ...
  val create : ?location:LatLng.t -> ?stopover:bool -> unit -> t [@@js.builder]
...
module DirectionsService : sig
  ...
  val route :
    DirectionsRequest.t ->
    (DirectionsResult.t -> directions_status -> unit) ->
    unit
    [@@js.call]
end [@js.scope "google.maps"]
...
module PlaceAspectRating : sig
  ...
  val create : ?rating:int -> ?type':(string[@js "type"]) -> unit -> t
    [@@js.builder]
...
module PhotoOptions : sig
  ...
  val create : ?max_height:int -> ?max_width:int -> unit -> t [@@js.builder]
...
module PlacePhoto : sig
  ...
  val set_html_attributions : t -> int -> unit [@@js.verbatim_names]

  val set_width : t -> int -> unit [@@js.set]
end [@js.scope "google.maps.places"]

module PlaceGeometry : sig
  type t

  val create : ?location:LatLng.t -> ?viewport:LatLngBounds.t -> unit -> t
    [@@js.builder]
...
module PlaceResult : sig
  ...
  val international_phone_number : t -> string
    [@@js.get "international_phone_number"]
  ...
  val set_address_components : t -> GeocoderAddressComponent.t list -> unit
    [@@js.set]

  val set_aspects : t -> PlaceAspectRating.t list -> unit [@@js.set]

  val set_formatted_address : t -> string -> unit [@@js.set "formatted_address"]

  val set_formatted_phone_number : t -> string -> unit
    [@@js.set "formatted_phone_number"]

  val set_geometry : t -> PlaceGeometry.t -> unit [@@js.set]

  val set_html_attributions : t -> string list -> unit
    [@@js.set "html_attributions"]

  val set_icon : t -> string -> unit [@@js.set]

  val set_international_phone_number : t -> string -> unit
    [@@js.set "international_phone_number"]

  val set_name : t -> string -> unit [@@js.set]

  val set_permanently_closed : t -> bool -> unit [@@js.set "permanently_closed"]
...
type rank_by = Prominence [@js 0] | Distance [@js 1] [@@js.enum]
...
module PlacesService : sig
  ...
  val get_details :
    t ->
    PlaceDetailsRequest.t ->
    (PlaceResult.t -> places_service_status -> unit) ->
    unit
    [@@js.call]

  val nearby_search :
    t ->
    PlaceSearchRequest.t ->
    (PlaceResult.t list ->
  ...
  val radar_search :
    t ->
    RadarSearchRequest.t ->
    (PlaceResult.t list -> places_service_status -> unit) ->
    unit
    [@@js.call]
...
module ComponentRestrictions : sig
  ...
  val create : country:string -> t [@@js.builder]
...
module PredictionSubstring : sig
  ...
  val create : ?length:int -> ?offset:int -> unit -> t [@@js.builder]
...
module PredictionTerm : sig
  ...
  val create : ?offset:int -> ?value:string -> unit -> t [@@js.builder]
...
module QueryAutocompletePrediction : sig
  ...
  val set_matched_substrings : t -> PredictionSubstring.t -> unit
    [@@js.verbatim_names]
...
module AutocompleteOptions : sig
  ...
  val set_component_restrictions : t -> ComponentRestrictions.t -> unit
    [@@js.set]
...
module AutocompletePrediction : sig
  ...
  val set_matched_substrings : t -> PredictionSubstring.t list -> unit
    [@@js.verbatim_names]
...
module AutocompletionRequest : sig
  ...
  val set_componentRestrictions : t -> ComponentRestrictions.t -> unit
    [@@js.set]
...
module Autocomplete : sig
  ...
  val new_autocomplete : ?opts:AutocompleteOptions.t -> Converter.Element.t -> t
    [@@js.new]
...
module DistanceMatrixResponseRow : sig
  ...
  val create : elements:DistanceMatrixResponseElement.t list -> t [@@js.builder]

  val elements : t -> DistanceMatrixResponseElement.t list [@@js.get]

  val set_elements : t -> DistanceMatrixResponseElement.t list -> unit
    [@@js.set]
end
...
module DistanceMatrixService : sig
  ...
  val get_distance_matrix :
    ...
    (DistanceMatrixResponse.t -> distance_matrix_status -> unit) ->
    unit
    [@@js.call]
end [@js.scope "google.maps"]
...
module DrawingControlOptions : sig
  ...
  val create :
    ?drawing_modes:overlay_type list -> ?position:control_position -> unit -> t
    [@@js.builder]
...
module DrawingManagerOptions : sig
  ...
  val set_drawing_control_options : t -> DrawingControlOptions.t -> unit
    [@@js.set]
...
module DrawingManager : sig
  ...
  val new_drawing_manager : ?options:DrawingManagerOptions.t -> unit -> t
    [@@js.new]
...
end [@js.scope "google.map.drawing"]
...
module WeightedLocation : sig
  ...
  val create : ?location:LatLng.t -> ?weight:float -> unit -> t [@@js.builder]
...
module PathElevationRequest : sig
  ...
  val create : ?path:LatLng.t list -> samples:int -> t [@@js.builder]
...
module LocationElevationRequest : sig
  ...
  val create : locations:LatLng.t list -> t [@@js.builder]
...
module ElevationResult : sig
  ...
  val create :
    ?elevation:float -> ?location:LatLng.t -> ?resolution:float -> unit -> t
    [@@js.builder]
...
module ElevationService : sig
  ...
  val get_elevation_along_path :
    ...
    (ElevationResult.t list -> elevation_status -> unit) ->
    unit
    [@@js.call]
...
module FusionTablesCell : sig
  ...
  val create : column_name:string -> value:string -> t [@@js.builder]
...
module FusionTablesHeatmap : sig
  ...
  val create : enabled:bool -> t [@@js.builder]
...
module FusionTablesMarkerOptions : sig
  ...
  val create : icon_name:string -> t [@@js.builder]
...
module FusionTablesStyle : sig
  ...
  val set_polyline_options : t -> FusionTablesPolylineOptions.t -> unit
    [@@js.set]
...
module FusionTablesLayer : sig
  ...
  val new_fusion_table_layer : options:FusionTablesLayerOptions.t -> t
    [@@js.new]
...
module KmlAuthor : sig
  ...
  val create : email:string -> name:string -> uri:string -> t [@@js.builder]
...
module KmlLayer : sig
  ...
  val new_kml_layer : ?opts:KmlLayerOptions.t -> unit -> t [@@js.new]
...
(* MaxZoom *)
type max_zoom_status = Ok [@js "OK"] | Error [@js "ERROR"] [@@js.enum]

module MaxZoomResult : sig
  type t

  val create : ?status:max_zoom_status -> ?zoom:int -> unit -> t [@@js.builder]
...
module SearchBoxOptions : sig
  ...
  val create : bounds:LatLngBounds.t -> t [@@js.builder]
...
module SearchBox : sig
  ...
  val new_search_box :
    Converter.Element.t -> ?opts:SearchBoxOptions.t -> unit -> t
    [@@js.new]
...
(*Scale Control Style *)
type scale_control_style = Default [@js 0] [@@js.enum]

module ScaleControlOptions : sig
  type t

  val create : style:scale_control_style -> t [@@js.builder]
...
module GroundOverlayOptions : sig
  ...
  val create : ?clickable:bool -> ?map:Map.t -> ?opacity:float -> unit -> t
    [@@js.builder]
...
module HeatmapLayer : sig
  ...
  val new_heatmap_layer : ?opts:HeatmapLayerOptions.t -> unit -> t [@@js.new]
...
end [@js.scope "google.maps.visualization"]
...
module ImageMapType : sig
  ...
  val new_image_map_type : opts:ImageMapTypeOptions.t -> t [@@js.new]
...
module StyledMapTypeOptions : sig
  ...
  val create :
    ?alt:string -> ?max_zoom:int -> ?min_zoom:int -> ?name:string -> unit -> t
    [@@js.builder]
...
module StyledMapType : sig
  ...
  val new_styled_map_type :
    MapTypeStyle.t -> ?opts:StyledMapTypeOptions.t -> unit -> t
    [@@js.new]
...
module OverlayCompleteEvent : sig
  ...
  val create :
    ?overlay:(* WARNING : Not Ojs.t but shapes *)
             Ojs.t ->
...
module SaveWidgetOptions : sig
  ...
  val create : ?attribution:Attribution.t -> ?place:MarkerPlace.t -> unit -> t
    [@@js.builder]
...
module SaveWidget : sig
  ...
  val new_save_widget : Ojs.t -> ?opts:SaveWidgetOptions.t -> unit -> t
    [@@js.new]
...
module TrafficLayerOptions : sig
  ...
  val create : map:Map.t -> t [@@js.builder]
...
module TrafficLayer : sig
  ...
  val new_traffic_layer : ?opts:TrafficLayerOptions.t -> unit -> t [@@js.new]
...
end [@js.scope "google.maps.geometry.encoding"]

module Spherical : sig
  val compute_area : LatLng.t -> ?radius:float -> unit -> float [@@js.global]

  val compute_distance_between :
    LatLng.t -> LatLng.t -> ?radius:float -> unit -> float
    [@@js.global]

  val compute_heading : LatLng.t -> LatLng.t -> float [@@js.global]

  val compute_length : LatLng.t list -> ?radius:float -> unit -> float
    [@@js.global]

  val compute_offset :
    LatLng.t -> float -> float -> ?radius:float -> unit -> LatLng.t
    [@@js.global]
  ...
  val compute_signed_area : LatLng.t list -> ?radius:float -> unit -> float
    [@@js.global]

  val interpolate : LatLng.t -> LatLng.t -> float -> LatLng.t [@@js.global]
end [@js.scope "google.maps.geometry.spherical"]

module Poly : sig
  val contains_location : LatLng.t -> Polygon.t -> bool [@@js.global]

  val is_location_on_edge_polygon :
    LatLng.t -> Polygon.t -> ?tolerance:float -> unit -> bool
    [@@js.global "isLocationOnEdge"]

  val is_location_on_edge_polyline :
    LatLng.t -> Polyline.t -> ?tolerance:float -> unit -> bool
    [@@js.global "isLocationOnEdge"]
end [@js.scope "google.maps.geometry.poly"]
